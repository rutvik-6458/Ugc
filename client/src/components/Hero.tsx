...
export default function Hero() {
    ...
    const galleryStripImages = [
        'https://media.istockphoto.com/id/894344596/photo/business-team-working-at-cafe-table.jpg?s=2048x2048&w=is&k=20&c=oWjalfYxcHWeULfpx10UUmhDwvK_bTUQUx8uo8qJpU8=',
        'https://media.istockphoto.com/id/1433168722/photo/board-room-meeting-with-multiracial-entrepreneurs-and-investors.jpg?s=2048x2048&w=is&k=20&c=2QBCOtqe3jsVItYYyz9_cqvaF4uiOCGt_LlaXgfQezo=',
        'https://plus.unsplash.com/premium_photo-1661331940916-60c2ec1a002a?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ];
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Upload product images and a model photo - our AI instantly produces professional lifestyle imagery and shoet - form videos optimized for commercials & Reels.
                            </motion.p>
